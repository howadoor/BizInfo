...
namespace Perenis.Core.Decoupling.Multimethods
{
    public class DispatcherCache
    {
        ...
        private readonly CopyOnWriteDictionary<RuntimeMethodHandle, Dispatcher> _methodCache =
        ...
        #region Nested type: CopyOnWriteDictionary
        ...
        private class CopyOnWriteDictionary<TKey, TValue>
        {
            ...
            public TValue this[TKey key]
            {
                ...
                set
                {
                    var copy = new Dictionary<TKey, TValue>(_current);
                    copy[key] = value;
                    _current = copy;
                }
            }
